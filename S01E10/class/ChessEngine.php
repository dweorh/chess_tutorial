...
class ChessEngine {
    ...
    public function set_game_board(array $board) : ChessEngine
    {
        $this->game_board = $board;
        return $this;
    }

    public function get_castling_figures() {
        return [
            'player_1' => $this->player_1_castling_figures,
            'player_2' => $this->player_2_castling_figures
        ];
    }

    public function set_castling_figures(array $player_1, array $player_2) : ChessEngine
    {
        $this->player_1_castling_figures = $player_1;
        $this->player_2_castling_figures = $player_2;
        return $this;
    }

    public function set_player_1_turn(bool $turn) : ChessEngine
    {
        $this->player_1_turn = $turn;
        return $this;
    }
